...
# Constantes
ANCHO = int(input("Dime el ancho para la cuadrícula: "))  # Ancho de la cuadrícula
ALTO = int(input("Dime el alto para la cuadrícula: "))  # Alto de la cuadrícula

VIVO = input("Dime el carácter de la célula")  # Carácter para la celda viva
